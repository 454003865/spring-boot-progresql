...
public class Link_apart implements Serializable {
    ...
    private Long out_id;
    @JsonProperty(value = "apart_state")
    private int apart_state;
    ...
    public int getApart_state() {
        return apart_state;
    }

    public void setApart_state(int apart_state) {
        this.apart_state = apart_state;
    }

    public Link_apart(String id, String link_id, String wkt, String ways_ids, String name, Long in_id, Long out_id) {
        this.id = id;
